...
const stageData={
'Early Years':null,
'EARLY YEARS':{title:'A confident beginning.',copy:'A nurturing environment where children discover the joy of learning, build independence and develop strong social foundations.',img:assetPath+'ais-campus-left-wing.jpg'},
'NURSERY':{title:'Curiosity starts here.',copy:'Play, language, exploration and relationships come together to create a strong foundation for lifelong learning.',img:assetPath+'ais-campus-center.jpg'},
'KG':{title:'Growing capable learners.',copy:'Children strengthen communication, early numeracy, creativity and confidence through purposeful learning experiences.',img:assetPath+'ais-campus-right-wing.jpg'},
'PRIMARY':{title:'Knowledge with purpose.',copy:'Learners build academic strength while developing critical thinking, responsibility, collaboration and confidence.',img:assetPath+'ais-campus-wide.jpg'},
'JUNIOR HIGH SCHOOL':{title:'Ready for the next chapter.',copy:'Students deepen subject knowledge, leadership, discipline and independent thinking as they prepare for future pathways.',img:assetPath+'ais-campus-grounds.jpg'}};
...
const facilityData={CLASSROOMS:['Learning spaces designed for focus and interaction.',assetPath+'ais-campus-center.jpg'],SCIENCE:['Spaces that support curiosity, observation and discovery.',assetPath+'ais-campus-right-wing.jpg'],ICT:['Digital learning environments can be introduced here with approved AIS photography.',assetPath+'ais-campus-left-wing.jpg'],LIBRARY:['A place for reading, research, reflection and discovery.',assetPath+'ais-campus-grounds.jpg'],SPORTS:['Sports and activity imagery should be added from the approved AIS archive.',assetPath+'ais-campus-wide.jpg'],CAMPUS:['The AIS campus at Bustan-e-Ahmad, Ashongman.',assetPath+'ais-campus-hero-premium.jpg']};
